...
public class RobotMap {
  ...
  public static final PWMVictorSPX frontL = new PWMVictorSPX(6);
  ...
  public static final PWMVictorSPX armMotorOne = new PWMVictorSPX(1);
  public static final PWMVictorSPX armMotorTwo = new PWMVictorSPX(2);
